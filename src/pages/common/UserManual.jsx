        ...
        <div className="manual-section">
          ...
          <div className="manual-item">
            ...
            <ol>
              ...
              <li>건물 내의 <strong>[호실 생성]</strong>을 통해 101호, 201호 등 각 방의 정보를 세팅합니다. <strong>(최대 3장까지 호실 사진도 등록할 수 있습니다.)</strong></li>
            </ol>
          </div>
          ...
          <div className="manual-item">
            ...
            <ol>
              ...
              <li>계약 등록이 끝나면 곧바로 <strong>[입주키트 작성]</strong> 화면으로 넘어갑니다.
                <ul>
                  <li>4단계 위자드를 통해 <strong>공동현관/호실 비밀번호, 도어락 마스터 비밀번호, 와이파이, 쓰레기 배출 요일 및 비상 연락망</strong> 등을 꼼꼼하게 입력합니다. (이전에 썼던 내용은 자동 저장되어 편리합니다)</li>
                  <li><em>💡 안심하세요! 여기서 작성한 비밀번호 등의 민감한 정보는 세입자가 전자서명을 완료하고 보증금을 입금하기 전까지는 자물쇠로 잠겨 보이지 않습니다.</em></li>
                </ul>
              </li>
              <li><strong>[전자서명 요청 링크 생성하기]</strong>를 누르면 세입자의 카카오톡이나 문자로 입주안내문이 발송됩니다. 이제 세입자가 전화로 비밀번호를 묻지 않습니다!</li>
            </ol>
          </div>
          ...
          <div className="manual-item">
            ...
            <ol>
              ...
              <li><strong>[미납 독촉 알림 쿨타임]</strong>: 임차인 보호를 위해 미납 독촉 알림톡은 '3일에 1회', '월 최대 3회'까지만 발송 가능하도록 안전 장치가 적용되어 있습니다. (야간 20:00 ~ 09:00 발송 제한)</li>
          ...
          <div className="manual-item">
            ...
            <ol>
              ...
              <li><strong>[방 내놓기]</strong>: 세입자가 퇴실하여 공실이 발생하면, 호실 상세 페이지에서 <strong>'주거래 중개사에게 방 내놓기'</strong> 버튼을 클릭하세요. (※ 무분별한 알림 방지를 위해 1시간에 1회만 발송 가능합니다.)</li>
        ...
        <div className="manual-section">
          ...
          <div className="manual-item">
            ...
            <ol>
              ...
              <li><strong>[입주키트 확인]</strong>: 전자서명과 보증금 납부가 완료되면 공동현관 비밀번호, 와이파이, 분리수거 위치 등 입주에 필요한 모든 정보의 잠금이 해제되어 언제든 앱에서 꺼내 볼 수 있습니다.</li>
            </ol>
          </div>
